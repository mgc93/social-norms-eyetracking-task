function [position, RT, answer] = snSlideScaleTrialNoEyeNoSocial(sID,trial, trialN, erTrial, trackEye, screenPointer, question, rectC, rectS, rectB, ansRect, anchorsTop, anchorsBottom,  shiftNumberUp, shiftNumberDown, varargin)
%
