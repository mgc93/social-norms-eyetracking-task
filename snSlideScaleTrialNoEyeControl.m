function [position, RT, answer] = snSlideScaleTrialNoEyeControl(sID,trial, trialN, erTrial,trackEye, screenPointer, question, rectC, rectS, rectB, ansRect, anchorsTop, anchorsBottom,  shiftNumberUp, shiftNumberDown, varargin)
%
...
while answer == 0
    ...
    Screen('FrameRect',screenPointer, framecolorself, rectC(ansRect,:), 1);
...
%             % added frame color for self :)
%             Screen('FrameRect',screenPointer, framecolorother, rectC(j,:), 2);
%         end
%     end    
